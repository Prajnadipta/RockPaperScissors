...
l1 = Label(root, text='Player', font=('Comic Sans MS', 25))
l2 = Label(root, text='Computer', font=('Comic Sans MS', 25))
l3 = Label(root, text='Vs', font=('Comic Sans MS', 40))
...
# Default image
img_p = Image.open("default2.jpeg")
...
# Paper image
paper_p = Image.open('paper2.jpeg')
...
# Scissor image
scissor_p = Image.open('scissor2.jpeg')
...
# Selection image
img_s = Image.open("Selection3.jpeg")
img_s = img_s.resize((300, 230))
...
# Putting result on canvas
    canvas.create_text(400, 650, text='Result:- '+res, fill="black", font=('Comic Sans MS', 25), tag='result')
...
rock_b.place(x=45, y=400)

# Button for selecting paper
paper_b = Button(root, text='Paper', command=lambda: game(2))
paper_b.place(x=128, y=400)

# Button for selecting scissor
scissor_b = Button(root, text='Scissor', command=lambda: game(3))
scissor_b.place(x=220, y=400)

# Button for clear
clear_b = Button(root, text='CLEAR', font=('Lora', 10, 'bold'), width=10, command=clear).place(x=370, y=28)
